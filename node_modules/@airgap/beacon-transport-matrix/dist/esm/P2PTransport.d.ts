...
import { ExtendedP2PPairingResponse, Storage, StorageKey, TransportType, P2PPairingRequest } from '@airgap/beacon-types';
...
export declare class P2PTransport<T extends P2PPairingRequest | ExtendedP2PPairingResponse, K extends StorageKey.TRANSPORT_P2P_PEERS_DAPP | StorageKey.TRANSPORT_P2P_PEERS_WALLET> extends Transport<T, K, P2PCommunicationClient> {
    ...
    constructor(name: string, keyPair: KeyPair, storage: Storage, matrixNodes: string[], storageKey: K, iconUrl?: string, appUrl?: string);
