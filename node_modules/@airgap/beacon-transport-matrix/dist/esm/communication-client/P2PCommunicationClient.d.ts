...
import { Storage, P2PPairingRequest, ExtendedP2PPairingResponse, P2PPairingResponse } from '@airgap/beacon-types';
...
export declare class P2PCommunicationClient extends CommunicationClient {
    ...
    constructor(name: string, keyPair: KeyPair, replicationCount: number, storage: Storage, matrixNodes: string[], iconUrl?: string | undefined, appUrl?: string | undefined);
