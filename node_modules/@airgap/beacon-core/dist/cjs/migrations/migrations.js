...
var migrate = function (storage) { return __awaiter(void 0, void 0, void 0, function () {
    var lastSdkVersion, addMigration, _i, migrations_1, _a, version, migrationMethod, migrationError_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, storage.get(beacon_types_1.StorageKey.BEACON_SDK_VERSION)
            ...
            case 6:
                _i++;
                return [3 /*break*/, 2];
            case 7: return [4 /*yield*/, storage.set(beacon_types_1.StorageKey.BEACON_SDK_VERSION, constants_1.SDK_VERSION)];
            case 8:
                _b.sent();
                return [2 /*return*/];
        }
