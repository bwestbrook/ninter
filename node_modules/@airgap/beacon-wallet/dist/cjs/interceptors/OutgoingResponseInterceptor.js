            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3:
                        response = __assign({ senderId: senderId, version: beacon_core_1.BEACON_VERSION, appMetadata: ownAppMetadata }, message);
                    ...
                    case 7:
                        {
                            response = __assign({ senderId: senderId, version: beacon_core_1.BEACON_VERSION }, message);
                            interceptorCallback(response);
                        }
                        return [3 /*break*/, 11];
                    case 8:
